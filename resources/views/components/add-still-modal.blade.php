<div x-show="showaddmodal" x-data="{showaddmodal: false}" @open-addmodal.window="showaddmodal=true" 
x-on:closemodal.window="showaddmodal=false,showMessage=true" class="">
<div class=" h-screen animated fadeIn faster  fixed  left-0 top-0 flex justify-center items-center inset-0 z-50 outline-none focus:outline-none bg-no-repeat bg-center bg-cover" >
       ...
       <div class="w-1/2 relative p-4 bg-white rounded-lg shadow dark:bg-gray-800 sm:p-5">
            ...
            <div class="flex justify-between items-center pb-4 mb-4 rounded-t border-b sm:mb-5 dark:border-gray-600  ">
                ...
                <button  x-on:click="showaddmodal =!showaddmodal" id="closetbtn" type="button" class="text-gray-400 bg-transparent 
            ...
            <form>
                ...
                <div class="grid gap-4 mb-4">
                    ...
                    <div>
                     ...
                     Name
                        ...
                        <input type="text" name="stillName" id="title" 
                ...
                <div class="flex items-center space-x-4">
                    ...
                    <button type="button" wire:click="createStill()"  class="text-blue-600 inline-flex items-center
                     hover:text-white 
