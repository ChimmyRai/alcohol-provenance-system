<div x-show="showaddmodalAcc" x-data="{showaddmodalAcc: false,modalData: {}}" @open-addmodal.window="modalData=$event.detail;showaddmodalAcc=true" 
x-on:closemodal.window="showaddmodalAcc=false,showMessage=true" class="">
<div class=" h-screen animated fadeIn faster  fixed  left-0 top-0 flex justify-center  inset-0 z-50 outline-none focus:outline-none bg-no-repeat bg-center bg-cover " >
   	<div class="absolute bg-black opacity-80 inset-0 z-0"></div>
       

       <div class="w-1/2 relative p-4 bg-white rounded-lg shadow dark:bg-gray-800 sm:p-5 overflow-y-auto">
            <!-- Modal header -->
            ...
            <form>
               ...
               <div class="grid gap-4 mb-4 ">
                   <div>
                       <label  for="password" class="block mb-2 text-sm font-medium
                        ...
                        <div class="text-xs text-gray-500 m-2 px-2 border border-gray-200 rounded shadow-md">(minimum 6 characters.Should have at least 1 lowercase and 1 uppercase and 1 number and 1 symbol)</div>
                       <input type="password" name="password" id="password" class="bg-gray-50 border border-gray-300 text-gray-900 text-sm
                        rounded-lg focus:ring-primary-600 focus:border-primary-600 block w-full 
                        p-2.5 dark:bg-gray-700 dark:border-gray-600 dark:placeholder-gray-400 
                        dark:text-white dark:focus:ring-primary-500 dark:focus:border-primary-500"
                   ...
                   <div class="text-red-500 text-xs">@error('password') {{ $message }} @enderror</div>
               </div>
               <div class="grid gap-4 mb-4 ">
                   <div>
                       <label  for="password_confirmation" class="block mb-2 text-sm font-medium
                        text-gray-900 dark:text-white">Confirm password</label>
                       <input type="password" name="password_confirmation " id="password_confirmation" class="bg-gray-50 border border-gray-300 text-gray-900 text-sm
                        rounded-lg focus:ring-primary-600 focus:border-primary-600 block w-full 
                        p-2.5 dark:bg-gray-700 dark:border-gray-600 dark:placeholder-gray-400 
                        dark:text-white dark:focus:ring-primary-500 dark:focus:border-primary-500"
               ...
               <div class="flex items-center space-x-4">
                   ...
                   <button type="button" wire:click="create()"  class="text-blue-600 inline-flex items-center
                    hover:text-white 
