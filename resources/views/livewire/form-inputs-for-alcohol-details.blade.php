             ...
             <form>
               ...
               <div class="flex flex-wrap">
                 <div class="w-full lg:w-3/12 px-4">
                   ...
                   <div class="text-red-500 text-xs">@error('start_uid') {{ $message }} @enderror</div>
                 </div>
                 ...
                 <div class="w-full lg:w-3/12 px-4">
                   ...
                   <div class="text-red-500 text-xs">@error('sku') {{ $message }} @enderror</div>
                 </div>
                 <div class="w-full lg:w-3/12 px-4">
                   <div class="relative w-full mb-3">
                   ...
                   <div class="text-red-500 text-xs">@error('volume') {{ $message }} @enderror</div>
                 </div>
                 ...
                 <div class="w-full lg:w-3/12 px-4">
                   <div class="relative w-full mb-3">
                     ...
                     <input id="batchNumber" wire:model="batchNumber" type="number" 
                   ...
                   <div class="text-red-500 text-xs">@error('batchNumber') {{ $message }} @enderror</div>
                 </div>
                 ...
                 <div class="w-full lg:w-3/12 px-4">
                   ...
                   <div class="text-red-500 text-xs">@error('Total_bottles_each_batch') {{ $message }} @enderror</div>
                 </div>
               </div>
 ...
 class="my-12 h-px border-t-0 bg-transparent bg-gradient-to-r from-transparent via-neutral-500 to-transparent opacity-25 dark:opacity-100" bg-gradient-to-r from-transparent via-neutral-500 to-transparent opacity-25 dark:opacity-100" >
               ...
               <div class="flex flex-wrap">
                 <div class="w-full lg:w-3/12 px-4">
                   ...
                   <div class="text-red-500 text-xs">@error('productName') {{ $message }} @enderror</div>
                 </div>
                 <div class="w-full lg:w-3/12 px-4">
                   <div class="relative w-full mb-3">
                     <label class="block  text-blueGray-600 text-xs  mb-2" >
                   ...
                   <div class="text-red-500 text-xs">@error('productVariety') {{ $message }} @enderror</div>
                 </div>
                 <div class="w-full lg:w-3/12 px-4">
                   <div class="relative w-full mb-3">
                     <label class="block text-blueGray-600 text-xs  mb-2" >
                   ...
                   <div class="text-red-500 text-xs">@error('productCategory') {{ $message }} @enderror</div>
                 </div>
                 <div class="w-full lg:w-3/12 px-4">
                   <div class="relative w-full mb-3">
                     <label class="block  text-blueGray-600 text-xs  mb-2" >
                   ...
                   <div class="text-red-500 text-xs">@error('appearance') {{ $message }} @enderror</div>
                 </div>
                 <div class="w-full lg:w-3/12 px-4">
                   <div class="relative w-full mb-3">
                     <label class="block  text-blueGray-600 text-xs  mb-2" >
                   ...
                   <div class="text-red-500 text-xs">@error('alcoholContent') {{ $message }} @enderror</div>
                 </div>
                 <div class="w-full lg:w-3/12 px-4">
                   <div class="relative w-full mb-3">
                     <label class="block  text-blueGray-600 text-xs  mb-2" >
                   ...
                   <div class="text-red-500 text-xs">@error('creation_date') {{ $message }} @enderror</div>
                 </div>
                 <div class="w-full lg:w-3/12 px-4">
                   <div class="relative w-full mb-3">
                     <label class="block  text-blueGray-600 text-xs  mb-2" >
                   ...
                   <div class="text-red-500 text-xs">@error('created_by') {{ $message }} @enderror</div>
                 </div>
               </div>
 ...
 class="my-12 h-px border-t-0 bg-transparent bg-gradient-to-r from-transparent via-neutral-500 to-transparent opacity-25 dark:opacity-100">
               ...
               <div class="flex flex-wrap">
                 <div class="w-full lg:w-3/12 px-4">
                   ...
                   <div class="text-red-500 text-xs">@error('ingretype') {{ $message }} @enderror</div>
                 </div>
                 ...
                 <div class="w-full lg:w-3/12 px-4">
                   ...
                   <div class="text-red-500 text-xs">@error('origin') {{ $message }} @enderror</div>
                 </div>
                 ...
                 <div class="w-full lg:w-3/12 px-4">
                   ...
                   <div class="text-red-500 text-xs">@error('yeast') {{ $message }} @enderror</div>
                 </div>
                 ...
                 <div class="w-full lg:w-3/12 px-4">
                   ...
                   <div class="text-red-500 text-xs">@error('notes') {{ $message }} @enderror</div>
                 </div>
 ...
 class="my-12 h-px border-t-0 bg-transparent bg-gradient-to-r from-transparent via-neutral-500 to-transparent opacity-25 dark:opacity-100">
               ...
               <div class="flex flex-wrap">
                   <div class="w-full lg:w-4/12 px-4">
                       ...
                       <div class="text-red-500 text-xs">@error('Nose') {{ $message }} @enderror</div>
                     </div>
                     ...
                     <div class="w-full lg:w-4/12 px-4">
                       ...
                       <div class="text-red-500 text-xs">@error('Palate') {{ $message }} @enderror</div>
                     </div>
                     ...
                     <div class="w-full lg:w-4/12 px-4">
                       ...
                       <div class="text-red-500 text-xs">@error('Finish') {{ $message }} @enderror</div>
                     </div>
 ...
 class="my-12 h-px border-t-0 bg-transparent bg-gradient-to-r from-transparent via-neutral-500 to-transparent opacity-25 dark:opacity-100">
               ...
               <div class="flex flex-wrap">
                   <div class="w-full lg:w-3/12 px-4">
                       ...
                       <div class="text-red-500 text-xs">@error('process') {{ $message }} @enderror</div>
                     </div>
                     ...
                     <div class="w-full lg:w-3/12 px-4">
                       <div class="relative w-full mb-3">
                         ...
                         <select name="stilldetails" id="stilldetails" wire:model="stilldetails"
                         class="border-0 px-3 py-3 placeholder-blueGray-300 text-blueGray-600 bg-white 
                         rounded text-xs shadow focus:outline-none focus:ring w-full ease-linear transition-all duration-150">
                              @foreach($stills as $still)
                              <option value="{{$still->stillName}}, {{$still->stillType}},
                                {{$still->stillBuildDate}}, 
                                {{$still->stillLocation}}">
                                {{$still->stillName}}({{$still->stillBuildDate}})
                       ...
                       <div class="text-red-500 text-xs">@error('stilldetails') {{ $message }} @enderror</div>
                     </div>
                     ...
                     <div class="w-full lg:w-3/12 px-4">
                       ...
                       <div class="text-red-500 text-xs">@error('caskType') {{ $message }} @enderror</div>
                     </div>
                     ...
                     <div class="w-full lg:w-3/12 px-4">
                       ...
                       <div class="text-red-500 text-xs">@error('charLevel') {{ $message }} @enderror</div>
                     </div>
                     ...
                     <div class="w-full lg:w-3/12 px-4">
                       ...
                       <div class="text-red-500 text-xs">@error('caskNumber') {{ $message }} @enderror</div>
                     </div>
                     ...
                     <div class="w-full lg:w-3/12 px-4">
                       ...
                       <div class="text-red-500 text-xs">@error('caskedDate') {{ $message }} @enderror</div>
                     </div>
                     ...
                     <div class="w-full lg:w-3/12 px-4">
                       ...
                       <div class="text-red-500 text-xs">@error('distillerName') {{ $message }} @enderror</div>
                     </div>
                     ...
                     <div class="w-full lg:w-3/12 px-4">
                       ...
                       <div class="text-red-500 text-xs">@error('barrelingDate') {{ $message }} @enderror</div>
                     </div>
                     <div class="w-full lg:w-3/12 px-4">
                       <div class="relative w-full mb-3">
                         <label class="block  text-blueGray-600 text-xs  mb-2" >
                       ...
                       <div class="text-red-500 text-xs">@error('disorginDate') {{ $message }} @enderror</div>
                     </div>
 ...
 class="my-12 h-px border-t-0 bg-transparent bg-gradient-to-r from-transparent via-neutral-500 to-transparent opacity-25 dark:opacity-100">
               ...
               <div class="flex flex-wrap">
                   <div class="w-full lg:w-3/12 px-4">
                       <div class="relative w-full mb-3">
                         <label class="block  text-blueGray-600 text-xs  mb-2" >
                          ...
                          <span id="supplierBusinessName">{{$accounts->acountname}}</span>

                       </div>
                       <div class="text-red-500 text-xs">@error('supplierBusinessName') {{ $message }} @enderror</div>
                   </div>
                   <div class="w-full lg:w-3/12 px-4">
                       <div class="relative w-full mb-3">
                         <label class="block  text-blueGray-600 text-xs  mb-2" >
                           Supplier Business Number
                            ...
                            <span id="supplierBusinessNumber">{{$accounts->businessnumber}}</span>
                       </div>
                       <div class="text-red-500 text-xs">@error('supplierBusinessNumber') {{ $message }} @enderror</div>
                   </div>
                   ...
                   <div class="w-full lg:w-3/12 px-4">
                       ...
                       <span id="supplierPhysicalAddress">{{$accounts->businessAddress}}</span>
                       <div class="text-red-500 text-xs">@error('supplierPhysicalAddress') {{ $message }} @enderror</div>
                   </div>
               ...
               <hr
 class="my-12 h-px border-t-0 bg-transparent bg-gradient-to-r from-transparent via-neutral-500 to-transparent opacity-25 dark:opacity-100">
 <button  type="button" wire:click="validateInput()"  @inputs-validated.window="sendTransaction()"
